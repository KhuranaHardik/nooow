...
class EnterOtpForgotPasswordScreen extends StatefulWidget {
  final String email;
  final String? otp;

  const EnterOtpForgotPasswordScreen({
    Key? key,
    required this.email,
    required this.otp,
  }) : super(key: key);
  ...
  @override
  State<EnterOtpForgotPasswordScreen> createState() =>
      _EnterOtpForgotPasswordScreenState();
}

class _EnterOtpForgotPasswordScreenState
    extends State<EnterOtpForgotPasswordScreen> {
  ...
  void initState() {
    super.initState();
    _otpTextEditingController.text = widget.otp!;
    _otpFocus = FocusNode();
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomElevatedButton(
                        ...
                        onPressed: uiProvider.loading
                            ? () {}
                            : () async {
                                uiProvider.loaderTrue();
                                await apiServiceProvider
                                    .otpVerificationForgotPasswordProvider(
                                  context: context,
                                  body: {
                                    "email": widget.email,
